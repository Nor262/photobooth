          ...
          >
            ...
            <div className="mt-2">
              ...
              <div className="flex justify-center space-x-6 mt-2">
                ...
                {/* Github */}
                <a target="_blank" href="https://github.com/Nor262" className="text-black hover:text-blue-500 transition-colors">
                ...
                {/* LinkedIn */}
                <a target="_blank" href="https://www.linkedin.com/in/ph%C3%BAc-tr%E1%BA%A7n-640286342/" className="text-black hover:text-blue-500 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
