...
function PhotoCaptureContent() {
  ...
  const takeMockPhoto = () => {
    ...
    ctx.fillText(`Mock Photo ${capturedImages.length + 1}`, canvas.width / 2, canvas.height / 2);
    
    // Add a simple pattern to make it look less plain
            ...
            {cameraError ? (
              <div className="flex flex-col h-full">
                <div className="relative aspect-video bg-gray-100 rounded-xl flex flex-col items-center justify-center border-2 border-gray-200">
                  <p className="text-gray-500 text-center px-6 text-sm mb-4">
                    Unable to access camera. You can use mock images for testing.
                  </p>
